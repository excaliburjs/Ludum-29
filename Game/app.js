...
(function (Fx) {
    var Flash = (function () {
        function Flash(drawable, color, duration) {
        ...
        Flash.prototype.isComplete = function (actor /*not needed*/ ) {
...
var Enemy = (function (_super) {
    ...
    Enemy.prototype.createMovePath = function (path) {
        ...
        var isJoined = firstPoint.x === lastPoint.x && firstPoint.y === lastPoint.y;

...
var Bullet = /** @class */ (function (_super) {
    ...
    function Bullet(x, y, destX, destY) {
        var _this = _super.call(this, x, y, 3, 3, ex.Color.Red) || this;
        _this.bulletSpriteSheet = new ex.SpriteSheet(Resources.BulletTexture, 6, 1, 32, 32);
        _this.bulletAnimation = _this.bulletSpriteSheet.getAnimationForAll(game, 200);
        ...
        _this.dx = fv.x;
        _this.dy = fv.y;
        _this.bulletAnimation.loop = true;
        _this.addDrawing('default', _this.bulletAnimation);
        _this.setCenterDrawing(true);
        _this.remainingLife = Config.defaultEnemyBulletLife;
        return _this;
    }
...
var Config = /** @class */ (function () {
    ...
    Config.defaultKrakenAnimationChangeThreshold = 400; // todo hack to get around collision dx/dy and fast animation changes
    ...
    Config.defaultEnemyBulletWait = 2000; // in ms
    Config.defaultEnemyBulletSpeed = 300;
    Config.defaultEnemyAlertDistance = 500;
    Config.defaultEnemyBulletLife = 20000; // in ms
...
var DeathScene = /** @class */ (function (_super) {
...
var BaseLevel = /** @class */ (function (_super) {
    ...
    function BaseLevel(jsonPath) {
        ...
        _this._objectFactories = {
            ...
            Path: function (obj) {
                ...
                // push path
                _this.paths[obj.name] = obj.polyline.map(function (p) { return new ex.Point(p.x, p.y); });
            }
        };
        return _this;
    }
    BaseLevel.prototype.onInitialize = function (engine) {
        ...
        this.data.tilesets.forEach(function (ts) {
            ...
            // nighty night!
            ss.sprites.forEach(function (s) { return s.addEffect(new Fx.Multiply(Palette.ColorNightTime)); });
    ...
    BaseLevel.prototype.update = function (engine, delta) {
        _super.prototype.update.call(this, engine, delta);
        // kill enemies
        this.enemies = this.enemies.filter(function (enemy) { return !enemy._isKilled; });
    ...
    BaseLevel.prototype.load = function () {
        ...
        request.onload = function (e) {
            ...
            promises.forEach(function (p) { return p.load(); });
        };
        request.send();
        return complete;
    };
...
var Enemy = /** @class */ (function (_super) {
    ...
    function Enemy(key, x, y, width, height, color, health) {
        var _this = _super.call(this, x, y, Config.defaultEnemyWidth, Config.defaultEnemyHeight, color) || this;
        _this.key = key;
        _this.health = Config.defaultEnemyHealth;
        _this.alertStatus = AlertStatus.Calm;
        _this.rays = new Array();
        _this.originalRays = new Array();
        _this._rayVectors = new Array();
        _this._bulletTimer = 0;
        _this.alertSprite = new ex.Sprite(Resources.AlertTexture, 0, 0, 60, 60);
        _this.movePath = [];
        _this.setWidth(width || Config.defaultEnemyWidth);
        _this.setHeight(height || Config.defaultEnemyHeight);
        _this.health = health || _this.health;
        _this._travelVector = new ex.Vector(1, 0);
        _this._originalTravelVector = new ex.Vector(1, 0);
        _this._fovLength = Config.defaultEnemyFOV;
        _this._shipSheet = new ex.SpriteSheet(Resources.Ship1Texture, 3, 2, 191, 73);
        _this.addDrawing("full", _this._shipSheet.getSprite(0));
        _this.addDrawing("half", _this._shipSheet.getSprite(1));
        _this.addDrawing("eighty", _this._shipSheet.getSprite(2));
        var anim = _this._shipSheet.getAnimationByIndices(game, [3, 4, 5], 200);
        _this.addDrawing("explode", anim);
        _this.setCenterDrawing(true);
        _this.setDrawing("full");
...
var Kraken = /** @class */ (function (_super) {
    ...
    function Kraken(x, y, color, health) {
        var _this = _super.call(this, x, y, Config.defaultKrakenWidth, Config.defaultKrakenHeight, color) || this;
        _this.health = Config.defaultKrakenHealth;
        _this._travelVector = new ex.Vector(0, 0);
        _this._currentMode = KrakenMode.Idle;
        _this._lastAttackTime = Date.now();
        _this._spinning = false;
        _this._animationTimer = 0;
        _this.health = health || _this.health;
        var krakenSheet = new ex.SpriteSheet(Resources.KrakenTexture, 4, 3, 120, 60);
        krakenSheet.sprites.forEach(function (s) { return s.addEffect(new Fx.Multiply(Palette.ColorKrakenBlend)); });
        ...
        _this.setCenterDrawing(true);
        _this.addDrawing('idle', idleAnim);
        _this.addDrawing('attack', attackAnim);
        _this.addDrawing('swim', swimAnim);
        _this.setDrawing('idle');
        return _this;
    }
    ...
    Kraken.prototype.onInitialize = function (game) {
        ...
        var swimTimer = new ex.Timer(function () {
            if (_this._currentMode === KrakenMode.Swim) {
        ...
        if (this._currentMode === KrakenMode.Attack) {
            if (!this.actionQueue.hasNext()) {
                ...
                this.rotateBy(this.rotation + Math.PI, 200).callMethod(function () {
                    ...
                    _this._currentMode = KrakenMode.Swim;
...
var DistressEvent = /** @class */ (function (_super) {
...
var AttackEvent = /** @class */ (function (_super) {
...
var VictoryScene = /** @class */ (function (_super) {
